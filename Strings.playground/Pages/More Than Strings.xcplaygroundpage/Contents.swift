...
let noun2 = "controllers"


let story = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(emotion). But then they felt \(negativeEmotion). They were all out of \(noun2)"
