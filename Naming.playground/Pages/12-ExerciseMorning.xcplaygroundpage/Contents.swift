...
let playvideoGames = 120

let talkingwithFriends = 30

let takingoutGarbage = 5

let mowinglawn = 30

let thingsiLike = playvideoGames + talkingwithFriends

let thingsidontLike = takingoutGarbage + mowinglawn
